...
return [
    'products' => [
        'Generatoare' => [
            'Generator de curent Panzer SPG1500, 3 CP' => [
                'id' => '30100',
                ...
                'images' => [
                    ...
                    'assets/img/products/Generatoare/Generator-1-2.jpg',
                    'assets/img/products/Generatoare/Generator-1-3.jpg',
                ],
                'descriere' => '
                <table class="table-specification"><tbody><tr><td class="semibold">Brand</td><td><div>Panzer</div></td></tr><tr><td class="semibold">Garantie Persoana Fizica (luni)</td><td><div>24</div></td></tr><tr><td class="semibold">Garantie Persoana Juridica (luni)</td><td><div>6</div></td></tr><tr><td class="semibold">Model</td><td><div>SPG1500</div></td></tr><tr><td class="semibold">Tip</td><td><div>monofazic</div></td></tr><tr><td class="semibold">Putere maxima (W)</td><td><div>1100</div></td></tr><tr><td class="semibold">Tip motor</td><td><div>benzina</div></td></tr><tr><td class="semibold">Putere nominala (W)</td><td><div>1000</div></td></tr><tr><td class="semibold">Putere motor (CP)</td><td><div>3</div></td></tr><tr><td class="semibold">Capacitate rezervor (l)</td><td><div>5.5</div></td></tr></tbody></table>
                ',
                'descriereText' => [
                    '' => 'Generatorul de curent Panzer SPG1500 este un echipament util atunci cand aveti nevoie de o sursa independenta de energie electrica. Acesta este propulsat de un motor OHV de 3 CP, in patru timpi, cu sistem de racire, proiectat pentru a rula la un numar mare de rotatii pe minut si pentru a da o putere nominala continua.',
                    '' => 'Panzer SPG1500 este montat pe un cadru metalic rezistent care permite atat transportarea lui cu usurinta cat si fixarea lui acolo unde doriti sa-l utilizati. Pentru a nu afecta elctronicele sau sculele electrice sensibile la variatiile de tensiune este recomandat sa folositi si un stabilizator de tensiune.',
            ...
            'Generator de curent Panzer SPG2500, 5.5 CP' => [
                'id' => '30200',
                'category' => 'Generatoare',
                ...
                'images' => [
                    ...
                    'assets/img/products/Generatoare/Generator-2-2.jpg',
                    'assets/img/products/Generatoare/Generator-2-3.jpg',
                    'assets/img/products/Generatoare/Generator-2-4.jpg',
                ],
                'descriere' => '
                <table class="table-specification"><tbody><tr><td class="semibold">Brand</td><td><div>Panzer</div></td></tr><tr><td class="semibold">Garantie Persoana Fizica (luni)</td><td><div>24</div></td></tr><tr><td class="semibold">Garantie Persoana Juridica (luni)</td><td><div>6</div></td></tr><tr><td class="semibold">Model</td><td><div>SPG2500</div></td></tr><tr><td class="semibold">Tip</td><td><div>monofazic</div></td></tr><tr><td class="semibold">Putere maxima (W)</td><td><div>2200</div></td></tr><tr><td class="semibold">Tip motor</td><td><div>benzina</div></td></tr><tr><td class="semibold">Putere nominala (W)</td><td><div>2000</div></td></tr><tr><td class="semibold">Putere motor (CP)</td><td><div>5.5</div></td></tr><tr><td class="semibold">Voltmetru</td><td><div>Da</div></td></tr></tbody></table>
                ',
                'descriereText' => [
                '' => 'Generatorul de curent Panzer SPG 2500  este un echipament pentru uz casnic sau comercial, dotat cu motor pe benzina in 4 timpi, cu o putere de 5.5 CP. Acesta va produce curent electric pentru ca electrocasnicele si aparatele electrice sa continue sa functioneze chiar si in cazul unei calamitati sau a unei pene de curent. Pentru a le proteja de fluctuatiile de tensiune va fi necesar si un stabilizator de tensiune.',
                '' => 'Panzer SPG 2500 este echipat cu un senzor pentru nivelul scazut de ulei. Daca nivelul de ulei scade mai mult decat trebuie, senzorul va activa un dispozitiv de avertizare sau va opri motorul. Se recomanda folosirea benzinei fara plumb, cu o cifra octanica de 86 sau mai mare. Benzina fara plumb produce motorului si bujiei mai putine depozite si extinde durata de viata a sistemului de evacuare.',
                '' => 'Pentru folosirea in siguranta a acestui echipament se recomanda ca inainte sa porniti motorul sa verificati urmatoarele elemente: sa nu existe suruburi si piulite rupte sau slabite, sa curatati filtrul de aer, sa verificati nivelul uleiului de motortor, sa verificati nivelul benzinei si sa nu existe scurgeri de ulei sau benzina. ',    
                ],
                'meta' => [
            ...
            'Generator de curent, Stanley SG 3100, monofazic, 2.9 kW' => [
                'id' => '30300',
                'category' => 'Generatoare',
        ...
        'Masini-de-gaurit' => [
            ...
            'Masina de gaurit / insurubat Bosch EasyDrill 1200' => [
                'id' => '40200',
                'category' => 'Masini de gaurit',
                ...
                'images' => [
                    ...
                    'assets/img/products/Masini-de-gaurit/Masina-de-gaurit-2-2.jpg',
                ],
                'descriere' => '<table class="table-specification"><tbody><tr><td class="semibold">Brand</td><td><div>Bosch</div></td></tr><tr><td class="semibold">Garantie Persoana Fizica (luni)</td><td><div>24</div></td></tr><tr><td class="semibold">Garantie Persoana Juridica (luni)</td><td><div>12</div></td></tr><tr><td class="semibold">Destinatie recomandata </td><td><div>hobby</div></td></tr><tr><td class="semibold">Tensiune alimentare (V)</td><td><div>12</div></td></tr><tr><td class="semibold">Capacitate (Ah)</td><td><div>1.5</div></td></tr><tr><td class="semibold">Turatia nominala (rot/min)</td><td><div>1650</div></td></tr><tr><td class="semibold">Model</td><td><div>EasyDrill 1200</div></td></tr><tr><td class="semibold">Acumulator tip</td><td><div>Li - Ion</div></td></tr><tr><td class="semibold">Tipul mandrinei</td><td><div>rapida</div></td></tr></tbody></table>',
                'descriereText' => [
                    '' => 'EasyDrill 1200 de la Bosch, este mica, usoara dar puternica, si functioneaza gratie tehnologiei acumulatorilor litiu-ion. Cu ajutorul acestei scule electrice puteti realiza atat activitati de gaurire cat si de insurubare/desurubare.',  
                    ],
                ],
                'meta' => [
            ...
            'Masina de gaurit / insurubat Black&Decker BDCDC 18' => [
                'id' => '40300',
                'category' => 'Masini de gaurit',
                ...
                'descriereText' => [
                    '' => 'Masina compacta de gaurit si insurubat Black&Decker BDCDC 18 este dotata cu 1 acumulator Li-Ion 18 V, 1.5 Ah si dispune de un design ergonomic. Mandrina rapida din dotare are capacitatea de 10 mm si este prevazuta cu sistem de blocare automat ce permite schimbarea rapida a varfului de insurubat cu o singura mana.',  
                    ],
                ],
                'meta' => [
        ...
        'Picamare' => [
            'Ciocan demolator, Hikoki H41MB2, 950 W' => [
                'id' => '50100',
                'category' => 'Picamare',
                ...
                ',
                'descriereText' => [
                    '' => 'Ciocanul demolator Hikoki H41MB2 este o scula electrica din gama profesionala, echipata cu un motor de 950 W care va ajuta in activitatile de demolare si remodelare.  Cu ajutorul accesoriilor (dalti, burghie, spituri) puteti desprinde gresia si faianta de pe pereti sau planseu, puteti scoate borduri, puteti darama zidarie sau beton.', 
                ],
                'meta' => [
            ...
            'Ciocan demolator Bosch GSH16-28 1750 W' => [
                'id' => '50200',
                'category' => 'Picamare',
                ...
                ',
                'descriereText' => [
                    '' => 'Performante extrem de ridicate la indepartarea materialului datorita energiei de percutie de 45 J si puterii motorului de 1.750 W, indepartand zilnic 13 tone de material.', 
                    '' => 'Sistem de amortizare a vibratiilor Vibration Control pentru reducerea vibratiilor daunatoare sanatatii, permitand astfel o durata de utilizare mai indelungata, insotita de o manevrare mai confortabila.',
                ],
                'meta' => [
        ...
        'Betoniere' => [
            'Betoniera Hobbyst 140L 550W' => [
                ...
                ',
                'descriereText' => [
                    '' => 'Betoniera Hobbyst are o capacitate a cuvei de 140 de litri si este destinata producerii de beton, mortar si ipsos.',
                    '' => 'Beneficiaza de un motor electric monofazat cu puterea de 550 W si se conecteaza la reteaua de electricitate de 230V si 50 Hz. Aceasta betoniera este dublu izolata pentru clasa de protectie II si categoria IP45.',
                    '' => 'Coroana betonierei Hobbyst este fabricata din fonta, material recunoscut pentru proprietatile sale de duritate, fapt ce favorizeaza utilizarea produsului pe parcursul a mai multi ani.',
                    '' => 'Roata de basculare cu regulator cu arc si cu inele de blocare ofera un control bun si usor al cuvei, care poate fi blocata in pozitia de amestec, de descarcare si de depozitare.',
                    '' => 'Betoniera nu poate fi tractata cu vehicule.',
                ],
                'meta' => [
            ...
            'Betoniera 120L 500W 74512' => [
                ...
                ',
                'descriereText' => [
                    '' => 'Aceasta betoniera cu capacitatea de 120 litri este destinata producerii de beton, mortar si ipsos.',
                    '' => 'Beneficiaza de un motor ce dezvolta o putere de 500 W si se conecteaza la reteaua de electricitate de 230V si 50 Hz. Aceasta betoniera este dublu izolata pentru clasa de protectie II si categoria IP44.',
                    '' => 'Coroana acestei betoniere este fabricata din fonta, material recunoscut pentru proprietatile sale de duritate, fapt ce favorizeaza utilizarea produsului pe parcursul a mai multi ani.',
                    '' => 'Betoniera nu este potrivita pentru amestecarea substantelor inflamabile sau explozive. Nu utilizati masina in zone in care vaporii de vopsea, solventii sau lichidele inflamabile prezinta un potential pericol. Nu folositi betoniera in scopuri pentru care nu a fost destinata.',
                    '' => 'Dimensiunile produsului ambalat sunt: 580 x 740 x 445 mm (L x l x H).',
                ],
                'meta' => [
            ...
            'Betoniera Evo II 350L 1500W' => [
                ...
                'descriere' => '<table class="table-specification"><tbody><tr><td class="semibold">Garantie Persoana Fizica (luni)</td><td><div>24</div></td></tr><tr><td class="semibold">Garantie Persoana Juridica (luni)</td><td><div>12</div></td></tr><tr><td class="semibold">Capacitate cuva (l)</td><td><div>350</div></td></tr><tr><td class="semibold">Capacitate de lucru (l)</td><td><div>300</div></td></tr><tr><td class="semibold">Material coroana</td><td><div>Fonta</div></td></tr><tr><td class="semibold">Putere motor (W)</td><td><div>1500</div></td></tr><tr><td class="semibold">Tensiune alimentare (V)</td><td><div>220</div></td></tr><tr><td class="semibold">Grad de protectie</td><td><div>IP55</div></td></tr><tr><td class="semibold">Greutate (kg)</td><td><div>216</div></td></tr><tr><td class="semibold">Nivelul de zgomot (dB)</td><td><div>90</div></td></tr></tbody></table>
                ',
                'descriereText' => [
                    '' => 'Betoniera Evo II este o betoniera profesionala, usor de utilizat, ce poate fi folosita pentru obtinerea betonului, mortarului sau cimentului. Betoniera are capacitatea cuvei de 350 litri si nivel scazut de zgomot (90 dB).',
                    '' => 'Beneficiaza de un motor electric monofazat cu puterea de 1500 W si se conecteaza la reteaua de electricitate de 220V si 50 Hz. Betoniera este dotata cu sistem de protectie impotriva improscarii cu apa (IP 55), protectie la suprasarcina si curgere in sens invers a incarcaturii.',
                    '' => 'Coroana betonierei Evo II este fabricata din fonta, material recunoscut pentru proprietatile sale de duritate, fapt ce favorizeaza utilizarea produsului pe parcursul a mai multi ani. Bascularea cuvei este usor de controlat prin intermediul sistemului de pinioane din fonta si a rotii de basculare de dimensiuni mari.',
                    '' => 'Cureaua de transmisie Poly-V contribuie la reducerea vibratiilor iar pentru imbunatatirea tractiunii aceasta poate fi stransa simplu si rapid cu ajutorul surubului de reglare amplasat pe partea laterala a carcasei motorului.
                    Betoniera nu poate fi tractata cu vehicule.',
                ],
                'meta' => [
                    'title' => 'Betoniera 120L 500W 74512 | MAXMANTECH',
